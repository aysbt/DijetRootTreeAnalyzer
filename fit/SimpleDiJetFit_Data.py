...
CMS_lumi.lumi_13TeV = str(float(LUMI))+" fb^{-1}"
...
FunctionType = 0
fileNameSuffix = "RunD_4param_JEC_Summer15_25nsV6_Silver_2445pb-1_plotSig_kfactor_1_BS_05"

####### INPUT #############
# data
#input_root_file="../output_Big/plots_data4T_Run2015D_Silverjson_2445pb-1_JEC_Summer15_25nsV6_withSF_golden_256630_258158_fromtree_BIG_kFactor_1/histo_data_mjj_fromTree0.9.root"
input_root_file="../output_Small/plots_data4T_Run2015D_Silverjson_2445pb-1_JEC_Summer15_25nsV6_withSF_golden_256630_258158_fromtree_Small_kFactor_1/histo_data_mjj_fromTree0.5.root"
#ainput_root_file="../output_BS/plots_data4T_Run2015D_Silverjson_2445pb-1_JEC_Summer15_25nsV6_withSF_golden_256630_258158_fromtree_BS_kFactor_1/histo_data_mjj_fromTree0.9.root"
...
#input_root_file="../output_Small/plots_data4T_Run2015D_Silverjson_2445pb-1_JEC_Summer15_25nsV6_withSF_golden_256630_258158_fromtree_Small_kFactor_1/histo_data_mjj_fromTree0.2.root"
...
##########OUTPUT########
outputDir="fit_directory_kfactor_1_BS_05/"
...
def doFitAndChi2(FunctionType,hist_mass,g,hist_mass_original):
    ...
    if( FunctionType==0 ):
        ...
        #Small 0.5 fit paremeetr
 	M1Bkg.SetParameter(0,7.45698e-05 )
	M1Bkg.SetParameter(1,5.58382)
	M1Bkg.SetParameter(2,8.23892)
	M1Bkg.SetParameter(3,0.568854)
...
def DrawFit(g, M1Bkg, hist_fit_residual_vsMass, FunctionType, nPar,
    ...
    pave_fit = TPaveText(0.2358691,0.04035043,0.5050171,0.2070085,"NDC")

    pave_fit.AddText("#chi^{{2}}/ndof = {0:.4g}/{1}".format(chi2, ndof))
    pave_fit.AddText("Jet1>0.5 & Jet2<0.5 or Jet1<0.5 & Jet2>0.5")
